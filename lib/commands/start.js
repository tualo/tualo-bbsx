(function() {
  ...
  module.exports = Start = (function(superClass) {
    ...
    Start.prototype.sequence_message = new MSG2CUSTARTPRINTJOB;

    Start.prototype.open_service_id = Message.SERVICE_BBS_PRINTJOB;

    Start.prototype.service_return_type = Message.TYPE_BBS_START_PRINTJOB;
