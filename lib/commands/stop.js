(function() {
  ...
  module.exports = Stop = (function(superClass) {
    ...
    Stop.prototype.sequence_message = new MSG2CUSTOPPRINTJOB;

    Stop.prototype.open_service_id = Message.SERVICE_BBS_PRINTJOB;

    Stop.prototype.service_return_type = Message.TYPE_BBS_STOP_PRINTJOB;
