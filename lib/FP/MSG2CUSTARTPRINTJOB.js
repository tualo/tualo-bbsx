(function() {
  ...
  module.exports = MSG2CUSTARTPRINTJOB = (function(superClass) {
    ...
    MSG2CUSTARTPRINTJOB.prototype.setAdvertHex = function(val) {
      return this.setAdvert(Buffer.from(val, 'base64'));
    };
    ...
    MSG2CUSTARTPRINTJOB.prototype.setApplictiondata = function(data) {
      var cutof, position;
      position = 0;
      this.app_data = Buffer.alloc(8096);
